...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("lucamaze-pixilart.png"));
	...
	if (mouseColor == endcolor) {
		System.out.println("Hey! Good job you won!");
	}
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("scarywind.wav"));
